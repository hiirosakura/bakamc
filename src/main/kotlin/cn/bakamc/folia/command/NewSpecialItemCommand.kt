...
internal val give: BakaCommand.(sender: CommandSender) -> Unit = { sender ->
...
internal val put: BakaCommand.(sender: CommandSender) -> Unit = { sender ->
    val player = (sender as Player).toServerPlayer()!!
...
internal val remove: BakaCommand.(sender: CommandSender) -> Unit = { sender ->
    val player = (sender as Player).toServerPlayer()!!
    if (args.size != 2) {
